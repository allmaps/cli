function gdalwarp (imageFilename, basename, outputDir, gcps, geoMask, tr = 0.5) {
  return `
#!/usr/bin/env bash
...
function gdalmerge (outputDir, inputTiffs, outputTiff) {
  // TODO: merge to VRT?!?!?!
  return `
...
function gdal2tiles (outputDir, outputTiff, layerId) {
  return `
gdal2tiles.py ${outputDir}/${outputTiff} ${outputDir}/${layerId}`.trim()
}
